defmodule SpheriumWebService.PermissionSetView do
  use SpheriumWebService.Web, :view

  def render("index.json", %{permission_sets: permission_sets}) do
    %{data: render_many(permission_sets, SpheriumWebService.PermissionSetView, "permission_set.json")}
  end

  def render("show.json", %{permission_set: permission_set}) do
    %{data: render_one(permission_set, SpheriumWebService.PermissionSetView, "permission_set.json")}
  end
  ...
  def render("permission_set.json", %{permission_set: permission_set}) do
    %{id: permission_set.id,
      ...
      permissions: render_many(permission_set.permissions, SpheriumWebService.PermissionView, "permission.json")}
  end
end
