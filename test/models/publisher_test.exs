defmodule SpheriumWebService.PublisherTest do
  ...
  @valid_attrs %{user: @user, description: "some content", image: "some content", name: "some content"}
  ...
  test "changeset with missing name" do
    changeset = Publisher.changeset(%Publisher{}, %{user: @user, description: "some content", image: "some content"})
    refute changeset.valid?
  end
end
